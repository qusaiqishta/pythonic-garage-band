...
def test_guitarist_str():
    joan = Guitarist("Joan")
    actual = str(joan)
    expected = " Joan usually play guitar "
...
def test_guitarist_repr():
    ...
    actual = repr(joan)
    expected = "Joan Jett get famus at 1997"
    assert actual == expected
...
def test_drummer_str():
    ...
    actual = str(sheila)
    expected = " Sheila E. usually play drums "
    assert actual == expected
...
def test_drummer_repr():
    sheila = Drummer("Sheila E.")
    actual = repr(sheila)
    expected = "Sheila E. get famus at 1981"
    assert actual == expected
...
def test_bassist_str():
    ...
    actual = str(meshell)
    expected = " Meshell Ndegeocello usually play bass "
    assert actual == expected
...
def test_bassist_repr():
    meshell = Bassist("Meshell Ndegeocello")
    actual = repr(meshell)
    expected = "Meshell Ndegeocello get famus at 1897"
    assert actual == expected
